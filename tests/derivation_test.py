...
class TestDerivation:
    def test_init(self):
        ...
        with pytest.raises(ValueError):
            D(None, "some-root", daughters=[N(1, "some-thing"), N(2, "some-thing")])
        with pytest.raises(ValueError):
    ...
    def test_fromstring(self):
        ...
        assert t.daughters == [
            T(
                "to ken",
                [Tk(2, r"token [ +FORM \"to\" ]"), Tk(3, r"token [ +FORM \"ken\" ]")],
            )
        ]
        # longer example
    ...
    def test_str(self):
        ...
        s = (
            r"(root (1 some-thing 0.4 0 5 (2 a-lex 0.8 0 1 "
            r'("a" 1 "token [ +FORM \"a\" ]")) '
    ...
    def test_entity(self):
        ...
        a = from_string(
            "(root (1 some-thing@some-type -1 -1 -1"
    ...
    def test_to_udf(self):
        ...
        s = (
            r"(root (1 some-thing@some-type 0.4 0 5 (2 a-lex@a-type 0.8 0 1 "
            r'("a b" 3 "token [ +FORM \"a\" ]" 4 "token [ +FORM \"b\" ]"))))'
        )
        assert from_string(s).to_udf(indent=1) == (
            "(root\n"
    ...
    def test_to_udx(self):
        ...
        s = (
            r"(root (1 some-thing@some-type 0.4 0 5 "
            ...
            "daughters": [
                {
                    ...
                    "daughters": [
                        ...
                        },
                        {
                            ...
                            "end": -1,
                            "form": "c",
                            "tokens": [{"id": 5, "tfs": r"token [ +FORM \"c\" ]"}],
                        },
                    ],
                }
            ],
            ...
            "daughters": [
                {
                    ...
                    "daughters": [
                        ...
                        {"id": 4, "entity": "c-lex", "score": -1.0, "form": "c"},
                    ],
                }
            ],
        }
    ...
    def test_from_dict(self):
        ...
        d = {
            "entity": "root",
            "daughters": [{"id": 1, "entity": "some-thing", "form": "a"}],
        }
        assert from_dict(d) == from_string(s)
        s = (
            r'(root (1 ^some-thing@some-type -1 -1 -1 ("a b"'
            r' 2 "token [ +FORM \"a\" ]"'
            r' 3 "token [ +FORM \"b\" ]")))'
        )
        d = {
