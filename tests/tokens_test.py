...
class TestYYToken:
    def test_init(self):
        with pytest.raises(TypeError):
            ...
            YYToken(
                1, 0, 1, Lnk.charspan(0, 1), [1], surface=".", ipos=0, lrules=["null"]
            )
            YYToken(
                1,
                0,
...
class TestYYTokenLattice:
    def test_fromstring(self):
        ...
        check_token(
            t, 1, 0, 1, None, [1], "dog", None, 0, ["null"], [("NN", 0.8), ("VV", 0.2)]
        )
        t = YY.from_string(token_v1_surface_pos).tokens[0]
        check_token(t, 1, 0, 1, None, [1], "dog", "Dog", 0, ["null"], [("NN", 1.0)])
        t = YY.from_string(token_v1_lrules).tokens[0]
        check_token(t, 1, 0, 1, None, [1], "dog", None, 0, ["lrule1", "lrule2"], [])
