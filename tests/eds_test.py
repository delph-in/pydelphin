...
def dogs_bark():
    return {
        "top": "e2",
        "nodes": [
            Node("e2", "_bark_v_1", type="e", edges={"ARG1": "x4"}),
...
def dogs_bark_mrs():
    return MRS(
        ...
        index="e2",
        rels=[
            EP("_bark_v_1", label="h1", args={"ARG0": "e2", "ARG1": "x4"}),
            EP("udef_q", label="h3", args={"ARG0": "x4", "RSTR": "h5", "BODY": "h6"}),
...
def test_from_mrs_broken_hcons_issue_319(dogs_bark_mrs):
    ...
    m = MRS(
        ...
        index="e2",
        rels=[
            EP("_probable_a_1", label="h1", args={"ARG0": "i4", "ARG1": "h5"}),
