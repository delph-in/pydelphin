...
def test_Result():
    ...
    mrs_d = {
        "top": "h0",
        "relations": [
            {"predicate": "_rain_v_1", "label": "h1", "arguments": {"ARG0": "e2"}}
        ],
    ...
    dmrs_d = {
        "nodes": [
            {"nodeid": 10000, "predicate": "_rain_v_1", "sortinfo": {"cvarsort": "e"}}
        ],
        ...
        "daughters": [  # , "type": "subjh_mc_rule"
            {
                ...
                "tokens": [  # , "type": "n_-_pr-it-x_le" , "from": 0, "to": 2
                    {
                        "id": 34,
                        "tfs": 'token [ +FORM \\"it\\" +FROM #1=\\"0\\" +TO \\"2\\" ]',
                    }
                ],
            },  # , "from": 0, "to": 2
            {
                        ...
                        "daughters": [  # , "type": "v_pst_inflrule"
                            {
                                ...
                                "end": 2,
                                "form": "rained.",
                                "tokens": [  # , "type": "v_-_it_le", "from": 3, "to": 10
                                    {
                                        "id": 32,
                                        "tfs": 'token [ +FORM \\"rained.\\" +FROM #1=\\"3\\" +TO \\"10\\" ]',
                                    }
                                ],
                            }
                        ],
...
def test_Response():
    ...
    toks_d = [{"id": 1, "start": 0, "end": 1, "from": 0, "to": 4, "form": "Dogs"}]
