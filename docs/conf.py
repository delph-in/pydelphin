...
project = 'pyDelphin'
copyright = '2014, Michael Wayne Goodman'
...
latex_documents = [
  ('index', 'pyDelphin.tex', 'pyDelphin Documentation',
...
man_pages = [
    ('index', 'pydelphin', 'pyDelphin Documentation',
...
texinfo_documents = [
  ('index', 'pyDelphin', 'pyDelphin Documentation',
   'Michael Wayne Goodman', 'pyDelphin', 'One line description of project.',
   'Miscellaneous'),
]
