...
class TDLLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            (r"\s+", Text),
            include("comment"),
            (r"(\S+?)(\s*)(:[=<+])", bygroups(Name.Class, Text, Operator), "typedef"),
            (
...
class SimpleMRSLexer(RegexLexer):
    ...
    tokens = {
        ...
        "mrs": [
            ...
            (r"\]", Punctuation, "#pop"),
            (r"<", Number, "lnk"),
            (r"(TOP|LTOP|INDEX)(\s*)(:)", bygroups(Name.Builtin, Text, Punctuation)),
            (
        ...
        "var": [(r"\s+", Text), (r"\[", Punctuation, "proplist"), (r"", Text, "#pop")],
        "proplist": [
            (r"\s+", Text),
            (
                r"([^:\s]+)(\s*)(:)(\s*)([^\s]+)",
        ...
        "ep": [
            ...
            (r"\]", Punctuation, "#pop"),
            include("strings"),
            (r"(LBL)(\s*)(:)", bygroups(Name.Namespace, Text, Punctuation)),
            (r"(ARG0)(\s*)(:)", bygroups(Name.Class, Text, Punctuation)),
            (r"(CARG)(\s*)(:)", bygroups(Name.Constant, Text, Punctuation)),
            (r"([^:\s]+)(\s*)(:)", bygroups(Name.Tag, Text, Punctuation)),
            include("vars"),
        ],
        "pred": [
            (r"\s+", Text),
