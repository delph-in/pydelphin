...
group.add_argument("-c", "--config", metavar="PATH", help="a .set configuration file")
group.add_argument("-m", metavar="PATH", help="the main .rpp file")
parser.add_argument(
    "-a", action="append", metavar="NAME", help="activate an external module"
)
parser.add_argument(
    "-f",
    "--format",
...
parser.add_argument(
    "--trace", action="store_true", help="print each step that modifies an input string"
)
